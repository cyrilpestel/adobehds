...
if options[:url] != nil
  if tvshowid == "robin-des-bois"
    cmd = "php #{lib}/AdobeHDS.php --delete --manifest \"#{options[:url]}\" --auth \"#{options[:url]}&als=0,2,0,1,0,NaN,0,0,0,36,f,0,660,f,s,UDIIHDKRBYRM,2.11.3,36\" --useragent \"Mozilla/5.0 (X11; Linux x86_64; rv:42.0) Gecko/20100101 Firefox/42.0\""
